...
\noindent
University ID\#:      \noindent\underline{\makebox[2in][l]{\hspace*{5pt}\textbf{N11707681}}}\\%\rule[-3pt]{2in}{0.4pt}\\
Net ID\#:\hspace{34pt} \noindent\underline{\makebox[2in][l]{\hspace*{7pt}\textbf{jk4560}}}\\%\rule[-3pt]{2in}{0.4pt}\\
...
\makebox[\textwidth]{\hfill\makebox[3in]{\hfill \textbf{Enrico Bertini}\hfill}}
...
\noindent
\makebox[\textwidth]{\hfill\makebox[3in]{\hrulefill}}\\
\makebox[\textwidth]{\hfill\makebox[3in]{\hfill \textbf{Cl\'audio T. Silva}\hfill}}
...
\noindent
\makebox[\textwidth]{\hfill\makebox[3in]{\hrulefill}}\\
\makebox[\textwidth]{\hfill\makebox[3in]{\hfill \textbf{Yindalon Aphinyanaphongs}\hfill}}
\makebox[\textwidth]{\hfill\makebox[3in]{\hfill Assistant Professor of \hfill}}
\makebox[\textwidth]{\hfill\makebox[3in]{\hfill Population Health and Medicine \hfill}}
\makebox[\textwidth]{\hfill\makebox[3in]{\rule[-4pt]{2in}{1pt}}}\\
\makebox[\textwidth]{\hfill\makebox[3in]{\hfill Date \hfill}}\\
\vspace{0.5in}
...
\noindent
\makebox[\textwidth]{\hfill\makebox[3in]{\hrulefill}}\\
\makebox[\textwidth]{\hfill\makebox[3in]{\hfill \textbf{Adam Perer}\hfill}}
\makebox[\textwidth]{\hfill\makebox[3in]{\hfill Research Scientist at \hfill}}
\makebox[\textwidth]{\hfill\makebox[3in]{\hfill IBM Research \hfill}}
\makebox[\textwidth]{\hfill\makebox[3in]{\rule[-4pt]{2in}{1pt}}}\\
\makebox[\textwidth]{\hfill\makebox[3in]{\hfill Date \hfill}}\\
...
\input{tex/introduction/contribution}
\input{tex/introduction/outline}
\input{tex/infuse}
\input{tex/prospector}
\input{tex/explainer}
\input{tex/aggexplain}
\input{tex/summary}
