...
All of those measures can be read from a confusion matrix, as shown in Figure~\ref{figs:cm_intro}.
...
Thus, in order to detect over-fitting, it is common to keep a separate data set, called hold-out, validation, or test data set, at hand that is not used for training the model.
