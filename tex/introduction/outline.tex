...
Following, we will introduce the Model Diagnostic workflow, aggregating instance-level explanations, in \chapref{chap:explainer} and discuss its capabilities in the context of binary input data.
...
Finally, in \chapref{chap:future_work}, we discuss the conclusions and future works.