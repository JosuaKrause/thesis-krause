...
%% Abstract section.
\input{aggexplain/abstract} % end of abstract
...
\input{aggexplain/introduction}
\input{aggexplain/relatedwork}
\input{aggexplain/motivation}
\input{aggexplain/experiment}
\input{aggexplain/results}
\input{aggexplain/discussion}
